        ...
        <div className="w-full md:w-1/2">
          <div className="w-full md:mx-3">
            ...
            <div className="flex flex-col items-center gap-5 md:flex-row md:items-start">
              ...
              <button
                className="flex items-center justify-center w-full gap-3 px-4 py-2 tracking-wider text-sm text-white hover:bg-primary-dark bg-primary hover:bg-paper rounded shadow border border-primary md:w-auto focus:outline-none"
